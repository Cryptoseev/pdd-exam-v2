      ...
      <div className="px-4 py-4 flex flex-col gap-3">
        ...
        <div className="mt-3 bg-blue-50 dark:bg-blue-950/50 rounded-2xl px-4 py-3.5 border border-blue-100 dark:border-blue-900">
          ...
          <p className="text-xs text-blue-600 dark:text-blue-400 leading-relaxed">
            Тренажёр экзамена ПДД России. Вопросы соответствуют официальным билетам ГИБДД.
            Все данные хранятся только на вашем устройстве — никакой регистрации не требуется.
          </p>
        </div>
